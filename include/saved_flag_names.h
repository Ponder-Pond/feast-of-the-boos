...
enum GameFlags {
    ...
    GF_MIM03_ItemBlock_LifeShroom               = GameFlag(0x39D),
    GF_MIM03_DefeatedRedPanser                  = GameFlag(0x39E),
    GF_MIM03_Item_FireFlower                    = GameFlag(0x39F),
    GF_MIM04_Gift_MagicalSeed3                  = GameFlag(0x3A0),
    GF_MIM07_Chest_BooBullyFormation            = GameFlag(0x3A1),
    GF_MIM07_DefeatedBooBully                   = GameFlag(0x3A2),
    GF_MIM07_Chest_SuperShroom                  = GameFlag(0x3A3),
    GF_MIM08_BadgeBlock_HPPlusA                 = GameFlag(0x3A4),
    GF_MIM08_Item_MapleSyrup                    = GameFlag(0x3A5),
    GF_MIM08_Chest_Oaklie                       = GameFlag(0x3A6),
    GF_MIM08_Item_ChestKey                      = GameFlag(0x3A7),
    GF_MIM08_UnlockedChest                      = GameFlag(0x3A8),
    GF_MIM08_DefeatedBeehive                    = GameFlag(0x3A9),
    GF_MIM08_Badge_ShrinkStomp                  = GameFlag(0x3AA),
    GF_MIM09_BadgeBlock_FPPlusA                 = GameFlag(0x3AB),
    GF_MIM10_JrTroopaEscaped                    = GameFlag(0x3AC),
    GF_MIM10_JrTroopaFreakout                   = GameFlag(0x3AD),
