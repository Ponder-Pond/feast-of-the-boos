...
extern EvtScript N(EVS_Attack_Seed);
...
EvtScript N(EVS_Attack_Seed) = {
    ...
    Wait(2)
    Call(SetGoalToTarget, ACTOR_SELF)
    Call(EnemyDamageTarget, ACTOR_SELF, LVar0, DAMAGE_TYPE_NO_CONTACT, 0, 0, DMG_SEED, BS_FLAGS1_TRIGGER_EVENTS)
    Switch(LVar0)
