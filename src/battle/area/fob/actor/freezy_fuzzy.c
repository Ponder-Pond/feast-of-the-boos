...
#define NAMESPACE A(freezy_fuzzy)
...
s32 N(DefaultAnims)[] = {
    STATUS_KEY_NORMAL,    ANIM_Fuzzy_Freezy_Idle,
    STATUS_KEY_STONE,     ANIM_Fuzzy_Freezy_Still,
    STATUS_KEY_SLEEP,     ANIM_Fuzzy_Freezy_Sleep,
    STATUS_KEY_POISON,    ANIM_Fuzzy_Freezy_Idle,
    STATUS_KEY_STOP,      ANIM_Fuzzy_Freezy_Still,
    STATUS_KEY_STATIC,    ANIM_Fuzzy_Freezy_Idle,
    STATUS_KEY_PARALYZE,  ANIM_Fuzzy_Freezy_Still,
    STATUS_KEY_DIZZY,     ANIM_Fuzzy_Freezy_Stunned,
    STATUS_KEY_FEAR,      ANIM_Fuzzy_Freezy_Stunned,
    STATUS_END,
};
    ...
    Switch(LVar0)
        ...
        CaseOrEq(EVENT_HIT)
            ...
            IfFlag(LVar0, DAMAGE_TYPE_SHOCK)
                ...
                SetConst(LVar1, ANIM_Fuzzy_Freezy_HurtShock)
            Else
                SetConst(LVar0, PRT_MAIN)
                SetConst(LVar1, ANIM_Fuzzy_Freezy_Hurt)
            EndIf
            ExecWait(EVS_Enemy_Hit)
        EndCaseGroup
        CaseEq(EVENT_BURN_HIT)
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_Fuzzy_Freezy_Burn)
            SetConst(LVar2, ANIM_Fuzzy_Freezy_BurnStill)
        ...
        CaseEq(EVENT_BURN_DEATH)
            ...
            ExecWait(EVS_Enemy_BurnHit)
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_Fuzzy_Freezy_BurnStill)
        ...
        CaseEq(EVENT_SHOCK_HIT)
            ...
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_Fuzzy_Freezy_Run)
        ...
        CaseOrEq(EVENT_IMMUNE)
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_Fuzzy_Freezy_Idle)
        ...
        CaseEq(EVENT_SCARE_AWAY)
            SetConst(LVar0, PRT_MAIN)
            SetConst(LVar1, ANIM_Fuzzy_Freezy_Run)
            SetConst(LVar2, ANIM_Fuzzy_Freezy_Anim09)
...
EvtScript N(EVS_Move_Clone) = {
    ...
    EndThread
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_Fuzzy_Freezy_Anim0D)
    Wait(130)
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_Fuzzy_Freezy_Walk)
    ...
    EndThread
    Wait(1)
    Call(SetAnimation, LVar0, 1, ANIM_Fuzzy_Freezy_Walk)
    ...
    Call(SetAnimation, LVar0, 1, ANIM_Fuzzy_Freezy_Idle)
...
EvtScript N(EVS_Attack_Leech) = {
    ...
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_Fuzzy_Freezy_Run)
    Call(SetGoalToTarget, ACTOR_SELF)
    Call(GetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
    Add(LVar0, 50)
    Set(LVar1, 0)
    ...
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_Fuzzy_Freezy_Idle)
    Label(100)
    Call(SetActorDispOffset, ACTOR_SELF, 0, 10, 0)
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_Fuzzy_Freezy_Leech)
    ...
    Switch(LVar0)
        ...
        CaseOrEq(HIT_RESULT_LUCKY)
            ...
            Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_Fuzzy_Freezy_Jump)
            Call(SetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
            Call(JumpToGoal, ACTOR_SELF, 11, FALSE, TRUE, FALSE)
            Call(SetActorDispOffset, ACTOR_SELF, 0, 0, 0)
            Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_Fuzzy_Freezy_Anim09)
            Call(GetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
            Sub(LVar0, 20)
            Call(SetActorJumpGravity, ACTOR_SELF, Float(3.0))
            Call(SetGoalPos, ACTOR_SELF, LVar0, LVar1, LVar2)
    ...
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_Fuzzy_Freezy_Bite)
    Wait(21)
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_Fuzzy_Freezy_Still)
...
EvtScript N(EVS_CountSummoners) = {
    ...
    Label(0)
        ...
        Switch(LVar2)
            CaseOrEq(ACTOR_TYPE_FREEZY_FUZZY)
