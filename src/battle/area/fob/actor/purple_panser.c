...
#define NAMESPACE A(purple_panser)

extern EvtScript N(EVS_Init);
extern s32 N(DefaultAnims)[];
extern s32 N(BitAnims)[];
extern EvtScript N(EVS_Idle);
extern EvtScript N(EVS_TakeTurn);
extern EvtScript N(EVS_HandleEvent);
extern EvtScript N(EVS_Attack_Bit);
...
EvtScript N(EVS_Attack_Bit) = {
    ...
    Wait(2)
    Call(SetGoalToTarget, ACTOR_SELF)
    Call(EnemyDamageTarget, ACTOR_SELF, LVar0, DAMAGE_TYPE_NO_CONTACT | DAMAGE_TYPE_ICE, 0, 0, DMG_BIT, BS_FLAGS1_TRIGGER_EVENTS)
    Switch(LVar0)
